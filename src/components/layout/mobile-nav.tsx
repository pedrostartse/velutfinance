...
import { LayoutDashboard, Wallet, Target, Plus, CalendarDays } from "lucide-react"
            ...
            <div className="grid grid-cols-5 items-center justify-items-center relative max-w-lg mx-auto">
                ...
                <div className="flex justify-center relative scale-110 -top-4">
                    <TransactionDialog
                        trigger={
                            <button
                                className="rounded-full bg-primary p-4 text-primary-foreground shadow-2xl transition-all active:scale-90 hover:shadow-primary/30"
